 ...
 * @see Table2
 */
@Service("bubbledata.Table2Service")
@Validated
public class Table2ServiceImpl implements Table2Service {
    ...
    @Autowired
    @Qualifier("bubbledata.Table2Dao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service bubbledata for table Table2 to {} format", exportType);
